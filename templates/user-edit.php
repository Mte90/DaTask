...
<div id="content-main" class="main" role="main">
	...
	<table class="form-table">
	    <tr>
		<th><label for="user_login"><?php _e( 'Username', DT_TEXTDOMAIN ); ?></label></th>
		<td><input type="text" name="user_login" id="user_login" value="<?php echo esc_attr( $profileuser->user_login ); ?>" disabled="disabled" class="form-control" /><em><span class="description"><?php _e( 'Usernames cannot be changed.', DT_TEXTDOMAIN ); ?></span></em></td>
	    </tr>
	    <tr>
		<th><label for="first_name"><?php _e( 'First Name', DT_TEXTDOMAIN ) ?></label></th>
		<td><input type="text" name="first_name" id="first_name" value="<?php echo esc_attr( $profileuser->first_name ) ?>" class="form-control" /></td>
	    </tr>

	    <tr>
		<th><label for="last_name"><?php _e( 'Last Name', DT_TEXTDOMAIN ) ?></label></th>
		<td><input type="text" name="last_name" id="last_name" value="<?php echo esc_attr( $profileuser->last_name ) ?>" class="form-control" /></td>
	    </tr>

	    <tr>
		<th><label for="nickname"><?php _e( 'Nickname', DT_TEXTDOMAIN ); ?> <span class="description"><?php _e( '(required)' ); ?></span></label></th>
		<td><input type="text" name="nickname" id="nickname" value="<?php echo esc_attr( $profileuser->nickname ) ?>" class="form-control" /></td>
	    </tr>

	    <tr>
		<th><label for="display_name"><?php _e( 'Display to Public as', DT_TEXTDOMAIN ) ?></label></th>
		<td>
	    ...
	    <tr>
		<th><label for="email"><?php _e( 'E-mail', DT_TEXTDOMAIN ); ?> <span class="description"><?php _e( '(required)' ); ?></span></label></th>
		<td><input type="text" name="email" id="email" value="<?php echo esc_attr( $profileuser->user_email ) ?>" class="form-control" />
		</td>
	    </tr>

	    <tr>
		<th><label for="url"><?php _e( 'Website', DT_TEXTDOMAIN ) ?></label></th>
		<td><input type="text" name="url" id="url" value="<?php echo esc_attr( $profileuser->user_url ) ?>" class="form-control" /></td>
	    </tr>
	    <tr>
		<th><label for="description"><?php _e( 'Biographical Info', DT_TEXTDOMAIN ); ?></label></th>
	    ...
	    <tr>
		<th><label for="pass1"><?php _e( 'New Password', DT_TEXTDOMAIN ); ?></label><br /><span class="description"><small><?php _e( "If you would like to change the password type a new one. Otherwise leave this blank." ); ?></small></span></th>
		<td>
	...
	<p class="submit">
	    ...
	    <input type="submit" class="btn btn-primary" value="<?php _e( 'Update Profile', DT_TEXTDOMAIN ); ?>" name="submit" />
	</p>
    </form>
</div>
<?php 
